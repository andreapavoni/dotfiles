...
describe "Javascript grammar", ->
  ...
  describe "support.variable.property.jsties", ->
    it "tokenizes properties", ->
      {tokens} = grammar.tokenizeLine('obj.prop1.prop2.prop3')
      expect(tokens[2]).toEqual value: 'prop1', scopes: ['source.js', 'support.variable.property.js']
      expect(tokens[4]).toEqual value: 'prop2', scopes: ['source.js', 'support.variable.property.js']
      expect(tokens[6]).toEqual value: 'prop3', scopes: ['source.js', 'support.variable.property.js']
  ...
  describe "Functions", ->
    ...
    it "tokenizes arrows", ->
      ...
      expect(tokens[2]).toEqual value: 'map', scopes: ['source.js', 'support.variable.property.js']
  ...
  describe "ES6 Spread", ->
    it "Tokenizes spreads", ->
      ...
      expect(tokens[7]).toEqual value: 'arr', scopes: ['source.js', 'support.variable.property.js']
